...
gen nonagri_gdp_ratio = secondary_gdp_ratio + tertiary_gdp_ratio
gen ln_nonagri_gdppc = ln_gdp_per_capita + ln(nonagri_gdp_ratio)
...
sum ln_nonagri_gdppc
gen ln_nonagri_gdppc_c = ln_nonagri_gdppc - r(mean)
gen ln_nonagri_gdppc_c_sq = ln_nonagri_gdppc_c^2
...
* Do regression
ds overwork2019 intensityw citycode ln_cons_per_capita employment_rate unemployment_insurance_coverage rd_workers_per10k ln_nonagri_gdppc ln_nonagri_gdppc_c_sq ln_avg_wage ln_avg_wage_c_sq, not
...
ds overwork2019 intensityw citycode ln_cons_per_capita employment_rate unemployment_insurance_coverage rd_workers_per10k ln_gdp_per_capita ln_gdp_pc_c_sq ln_nonagri_gdppc ln_nonagri_gdppc_c_sq, not
regress overwork2019 `r(varlist)'
vif 
